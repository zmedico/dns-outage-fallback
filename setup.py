...
from dns_resiliency_proxy import (
    __author__,
    __description__,
    __email__,
    __project__,
...
setup(
    ...
    package_dir={'': 'src'},
    py_modules=['dns_resiliency_proxy'],
    entry_points={
        'console_scripts': 'socket-burst-dampener = dns_resiliency_proxy:main',
    },
    python_requires = ">=3.6",
)
